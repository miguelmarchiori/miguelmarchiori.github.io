...
export default function BorderGlow({children,className='',edgeSensitivity=30,glowColor='0 85 62',backgroundColor='#11111a',borderRadius=28,glowRadius=40,glowIntensity=1,coneSpread=25,animated=false,colors=['#7f1d1d','#e11d2e','#ff6b75'],fillOpacity=.5}){
