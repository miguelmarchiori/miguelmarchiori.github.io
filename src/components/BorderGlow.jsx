...
export default function BorderGlow({children,className='',edgeSensitivity=30,glowColor='211 75 60',backgroundColor='transparent',borderRadius=28,glowRadius=28,glowIntensity=.4,coneSpread=25,animated=false,colors=['#a6c8ef','#5d9ce4','#c1daf7'],fillOpacity=.12}){
